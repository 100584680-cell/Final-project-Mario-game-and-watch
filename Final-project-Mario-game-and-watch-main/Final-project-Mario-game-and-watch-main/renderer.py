...
class Renderer:
    ...
    def draw_machines(self):
        u, v, w, h = 152, 224, 16, 16
        pyxel.blt(240, 125 - h, 0, u, v, w, h, 0)

        u, v, w, h = 120, 224, 16, 16
        pyxel.blt(240, 186 - h, 0, u, v, w, h, 0)
        u, v, w, h = 104, 224, 16, 16
        pyxel.blt(224, 186 - h, 0, u, v, w, h, 0)
        u, v, w, h = 120, 208, 16, 16
        pyxel.blt(240, 168 - h, 0, u, v, w, h, 0)
